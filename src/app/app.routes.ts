...
export const routes: Routes = [
  ...
  { path: 'connections',loadChildren: () => import('./views/connections/routes').then(m => m.routes)},
  ...
  { path: 'StockRegister',loadChildren: () => import('./views/stock-register/routes').then(m => m.routes)},
